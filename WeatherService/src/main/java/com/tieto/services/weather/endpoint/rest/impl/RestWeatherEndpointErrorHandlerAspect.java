...
@Aspect
@Component
public class RestWeatherEndpointErrorHandlerAspect {

	private static final Logger logger = LoggerFactory
			.getLogger(RestWeatherEndpointErrorHandlerAspect.class);

	@Autowired
	private IRestWeatherEndpointMapper mapper;

	@Around("@annotation(com.tieto.services.weather.endpoint.rest.RestWeatherEndpointMethod)")
